...
class BackgroundService : MethodChannel.MethodCallHandler, JobIntentService() {
    ...
    override fun onCreate() {
        ...
        synchronized(serviceStarted) {
            context = this
            if (engine == null) {
                val callbackHandle = DefaultPlugin.getDispatcherHandle(context)
        ...
        channel =
            MethodChannel(engine!!.getDartExecutor().getBinaryMessenger(), "home_widget/background")
    ...
    override fun onHandleWork(intent: Intent) {
        ...
        val args = listOf(DefaultPlugin.getHandle(context), data)
